...
public class AccountProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.topspeedsnail.provider.Account";
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "clients/#", CLIENTS_ID);
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case CLIENTS_ID:
                ...
                count = db.delete( CLIENTS_TABLE_NAME, _ID +  " = " + id +
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case CLIENTS_ID:
                count = db.update(CLIENTS_TABLE_NAME, values, _ID + " = " + uri.getPathSegments().get(1) +
                        (!TextUtils.isEmpty(selection) ? " AND (" +selection + ')' : ""), selectionArgs);
                break;
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case CLIENTS:
                return "vnd.android.cursor.dir/vnd.topspeedsnail.com.clients";

            case CLIENTS_ID:
                return "vnd.android.cursor.item/vnd.topspeedsnail.com.clients";
